...
//We will giving the bean and it will create the payload for CreateJobAPI
	...
	public static CreateJobPayload mapper(CreateJobBean bean) {
		...
		int mastServiceLoactionId= Integer.parseInt(bean.getMst_service_location_id());
		...
		CreateJobPayload payload = new CreateJobPayload(mastServiceLoactionId, mstPlatformId, mstWarrantyStatusId,oemId, customer,
		customerAddress,
		customerProduct,
		problemList);
